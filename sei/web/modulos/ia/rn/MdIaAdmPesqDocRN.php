 ...
 *
 * @modified 2026-06 fmees - request-scoped cache (perf); Assisted-by: GitHub Copilot (Claude Sonnet 4.6)
 */
...
class MdIaAdmPesqDocRN extends InfraRN
{
    ...
    // [fmees perf] request-scoped cache: one DB round-trip per class per request
